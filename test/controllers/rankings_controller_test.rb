...
class RankingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ranking" do
    assert_difference('Ranking.count') do
      post rankings_url, params: { ranking: { name: @ranking.name, score: @ranking.score } }, as: :json
    end
  ...
  test "should update ranking" do
    patch ranking_url(@ranking), params: { ranking: { name: @ranking.name, score: @ranking.score } }, as: :json
    assert_response 200
  end
